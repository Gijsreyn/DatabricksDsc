<#
    ...
    .DESCRIPTION
        ...
        uses. The property Reasons holds an array of DatabricksReason. Each
        DatabricksReason explains why a property of a DSC resource is not in
        desired state.
#>
class DatabricksReason
{
    [DscProperty()]
    [System.String]
    $Code
