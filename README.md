...
The documentation can be found in the [DatabricksDsc Wiki](https://github.com/dsccommunity/DatabricksDsc/wiki).
The DSC resources schema files is used to automatically update the
documentation on each PR merge.

### Examples

You can review the [Examples](/source/Examples) directory in the DatabricksDsc module
